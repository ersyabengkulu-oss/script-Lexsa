-- Script V38 The Real IY Fly Edition by Gemini
...
local SpeedBtn = CreateBtn("SPEED: 130", UDim2.new(0, 0, 0.66, 0), Color3.fromRGB(80, 80, 0), MainFrame)
...
-- LOGIKA FLY MURNI INFINITE YIELD
local function RealIYFly()
    ...
    spawn(function()
        while isFlying and char and root do
            ...
            -- INI RAHASIANYA: Velocity mengikuti arah LookVector kamera
...
SpeedBtn.MouseButton1Click:Connect(function()
    flySpeed = (flySpeed >= 300) and 50 or flySpeed + 40
